...
function Ke_portico3d(Ee::T, Ize::T, Iye::T, Ge::T, J0e::T, Le::T, Ae::T)
...
function Fe_viga(Le, q1y, q2y, q1z, q2z)
  ...
  [             0               ;   # fx no nó 1
    (3*q2y*Le)/20+(7*q1y*Le)/20 ;   # fy no nó 1
    (3*q2z*Le)/20+(7*q1z*Le)/20 ;   # fz no nó 1
                0               ;   # Tx no nó 1
    (q2z*Le^2)/30+(q1z*Le^2)/20 ;   # My no nó 1
    (q2y*Le^2)/30+(q1y*Le^2)/20 ;   # Mz no nó 1
                0               ;   # fx no nó 2
    (7*q2y*Le)/20+(3*q1y*Le)/20 ;   # fy no nó 2
    (7*q2z*Le)/20+(3*q1z*Le)/20 ;   # fz no nó 2
                0               ;   # Tx no nó 2
    -(q2z*Le^2)/20-(q1z*Le^2)/30;   # My no nó 2
    -(q2y*Le^2)/20-(q1y*Le^2)/30]   # Mz no nó 2
