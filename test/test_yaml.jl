@testset "YAML" begin
    ...
    ##############################################
    # No coordenadas
    @test_throws ErrorException LFrame.Le_YAML("data/yaml/yaml_no_coordenadas.yaml")

    ##############################################
    # No apoios
    @test_throws ErrorException LFrame.Le_YAML("data/yaml/yaml_no_apoios.yaml")

    ##############################################
    # No geometrias
    @test_throws ErrorException LFrame.Le_YAML("data/yaml/yaml_no_geometrias.yaml")

    ##############################################
    # No dados_elementos
    @test_throws ErrorException LFrame.Le_YAML("data/yaml/yaml_no_dados_elementos.yaml")

    ##############################################
    # Informa material que não existe em dados_elementos
    @test_throws ErrorException LFrame.Le_YAML("data/yaml/yaml_consist_dados_elementos.yaml")
